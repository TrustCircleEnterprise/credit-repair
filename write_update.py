  ...
  <div class="g2" style="margin-bottom:1.5rem">
    ...
    <div class="card">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        <button class="btn btn-primary" onclick="analyzeReport()" id="analyze-btn">Analyze Report &#8594;</button>
...
If you cannot read the document or find no negative items, output: NO_NEGATIVES_FOUND`
    ...
    if (data.content && data.content[0]) {
      ...
      statusEl.innerHTML = '<div class="upload-error">Could not read the file. Try a clearer image or paste accounts manually.</div>';
    }
  } catch (err) {
    statusEl.innerHTML = '<div class="upload-error">Error reading file: ' + err.message + '</div>';
  }
